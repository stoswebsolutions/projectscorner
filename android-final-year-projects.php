...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Android Final Year Projects | projects corner</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb py-5">
            <div class="container text-center py-5">
                <h3 class="text-white display-3 mb-4">Android Final Year Projects</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">IEEE Projects</a></li>
                    <li class="breadcrumb-item active text-white">Android Final Year Projects</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-fluid services py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 800px;">
                    ...
                    <h1 class="display-3">Android Final Year Projects</h1>
                </div>
                <div class="row g-4">
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-4 text-center text-md-start mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>www.projectscorners.in</a>, All right reserved.</span>
                    </div>
                    <div class="col-md-4">
