...
<body>
    ...
    <div class="container-fluid services py-5">
        <div class="container" style="padding-top: 1rem !important">
            <div class="mx-auto">
                <h1 class="text-center display-5">Projectscorner's Java Academic Projects</h1>
                <p>Welcome to Projectscorner's Java Projects service! We specialize in providing high-quality Java projects for students, professionals, and researchers. Our projects are meticulously designed to harness the power of Java programming language, offering hands-on experience and practical skills development in software development.</p>
                ...
                <ul>
                    <li class="justify-content">We offer a diverse range of Java projects covering various domains and functionalities, including but not limited to:
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item list-group-item-danger">Data Analysis and Visualization</li>
                            <li class="list-group-item list-group-item-warning">Artificial Intelligence and Machine Learning</li>
                        </ul>
                    </li>
    ...
    <div class="text-center">
        <p class="m-5 justify-content">Whether you're a student, researcher, or professional seeking to enhance your Java development skills, Projectscorner is your trusted partner for high-quality Java projects. Explore our curated list of project titles and embark on your journey towards academic excellence and professional success today.</p>
    </div>
    <!-- Footer Start -->
