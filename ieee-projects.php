    ...
    <div class="container-fluid services py-5">
        <div class="container py-5" style="padding-top: 1rem !important">
            <div class="mx-auto mb-5">
                ...
                <h1 class="text-center display-6">IEEE Projects Services</h1>
                <h5 class="text-primary">Project Selection and Customization:</h5>
                <ul>
                    <li class="justify-content">We offer a diverse range of IEEE standard projects in Python, Java, .NET (Dotnet), MATLAB, and other relevant technologies.</li>
                    <li class="justify-content">Our team assists clients in selecting projects that align with their interests, academic requirements, and career goals. We also provide customization options to tailor projects to specific needs and preferences.</li>
                </ul>
                <h5 class="text-primary">Project Implementation Support:</h5>
                <ul>
                    <li class="justify-content">We provide comprehensive support and guidance throughout the project implementation process, including project setup, coding assistance, debugging, and troubleshooting.</li>
                    <li class="justify-content">Our experienced team of developers and engineers is available to address any technical challenges and ensure smooth project execution.</li>
                </ul>
                <h5 class="text-primary">Documentation and Presentation Assistance:</h5>
                <ul>
                    <li class="justify-content">We assist clients in preparing project documentation, including project reports, presentations, and documentation according to IEEE standards.</li>
                    <li class="justify-content">Our goal is to help clients effectively communicate their project findings, methodologies, and results in a clear and concise manner.</li>
                </ul>
                <h5 class="text-primary">Project Demonstrations and Workshops:</h5>
                <ul>
                    <li class="justify-content">We conduct project demonstrations and workshops to enhance clients' understanding of project concepts, methodologies, and implementation techniques.</li>
                    <li class="justify-content">These interactive sessions provide hands-on experience and practical insights into project development, helping clients build confidence and proficiency in their chosen technology.</li>
                </ul>
                <h5 class="text-primary">Post-Project Support and Maintenance:</h5>
                <ul>
                    <li class="justify-content">We offer post-project support and maintenance services to address any issues or concerns that may arise after project completion.</li>
                    <li class="justify-content">Our team remains committed to ensuring the long-term success and sustainability of projects, providing ongoing assistance as needed.</li>
                </ul>
            </div>
            <div class="row g-4">
                <div class="col-lg-6">
