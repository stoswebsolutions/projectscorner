...
<body>
    ...
    <div class="container-fluid services py-5 bg-light">
        <div class="container">
            <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="display-5 fw-bold text-primary">Projectscorner's PHP IEEE Projects</h1>
                <p class="lead">We provide IEEE standard PHP projects, offering practical experience in building dynamic, scalable, and secure web applications.</p>
            </div>
            <div class="mb-4 wow fadeInUp" data-wow-delay="0.3s">
                <h5 class="text-primary">Mission Statement:</h5>
                <p class="fs-6 text-justify">At Projectscorner, we aim to deliver PHP projects that not only meet academic standards but also prepare learners for real-world web development challenges.</p>
            </div>
            <div class="row align-items-center g-5">
                <!-- Image first on desktop, second on mobile -->
                <div class="col-md-6 order-1 order-md-0 wow fadeInLeft" data-wow-delay="0.4s">
                    <img src="images/phpIEEE.jpg" alt="PHP IEEE Project Showcase" class="img-fluid rounded shadow-lg animate__animated animate__fadeInLeft">
                </div>
                <div class="col-md-6 order-0 order-md-1 wow fadeInRight" data-wow-delay="0.5s">
                    <ul class="ps-3">
                        <li class="mb-3">We offer a wide range of PHP projects in domains like:
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item list-group-item-primary">Content Management Systems (CMS)</li>
                                <li class="list-group-item list-group-item-secondary">E-Commerce Platforms</li>
                                <li class="list-group-item list-group-item-success">Social Networking Applications</li>
                                <li class="list-group-item list-group-item-danger">Booking and Reservation Systems</li>
                                <li class="list-group-item list-group-item-warning">Custom Web Portals</li>
                            </ul>
                        </li>
                        <li class="mt-3">Choose from our curated list of projects or request customization to match your needs and academic requirements.</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-hover shadow-sm" id="projectsTable">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>PCP901</td>
                        <td>Content Management System for Blogging</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>PCP902</td>
    ...
    <div class="text-center px-4 wow fadeInUp" data-wow-delay="0.3s">
        <p class="m-5 fs-6">Whether you’re a student or a developer, Projectscorner is your trusted partner for IEEE PHP projects. <strong>Learn, build, and grow with us!</strong></p>
    </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-md-4 text-center text-md-start">
                    <span>&copy; Projectscorner All rights reserved.</span>
                </div>
