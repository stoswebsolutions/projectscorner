...
<body>
    ...
    <div class="container-fluid services py-5 bg-light">
        <div class="container">
            <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="display-5 fw-bold text-primary">Projectscorner's .NET IEEE Projects</h1>
                <p class="lead">We specialize in IEEE standard .NET projects, offering cutting-edge solutions that prepare students and professionals for real-world applications.</p>
            </div>
            <div class="mb-4 wow fadeInUp" data-wow-delay="0.3s">
                <h5 class="text-primary">Mission Statement:</h5>
                <p class="fs-6 text-justify">At Projectscorner, our mission is to deliver high-quality, innovative .NET projects that foster creativity, problem-solving skills, and technical excellence, empowering learners to thrive in both academic and professional spheres.</p>
            </div>
            <div class="row align-items-center g-5">
                <!-- Image first on desktop, second on mobile -->
                <div class="col-md-6 order-1 order-md-0 wow fadeInLeft" data-wow-delay="0.4s">
                    <img src="images/dotnetIEEE.jpg" alt=".NET IEEE Project Showcase" class="img-fluid rounded shadow-lg animate__animated animate__fadeInLeft">
                </div>
                <div class="col-md-6 order-0 order-md-1 wow fadeInRight" data-wow-delay="0.5s">
                    <ul class="ps-3">
                        <li class="mb-3">We offer a diverse range of IEEE standard projects in .NET covering various domains, including:
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item list-group-item-primary">Web Development</li>
                                <li class="list-group-item list-group-item-secondary">Desktop Applications</li>
                                <li class="list-group-item list-group-item-success">Mobile Applications</li>
                                <li class="list-group-item list-group-item-danger">Cloud Computing</li>
                                <li class="list-group-item list-group-item-warning">Data Analytics</li>
                            </ul>
                        </li>
                        <li class="mt-3">Clients can choose from our curated list of project titles or request customization to suit their specific needs and goals.</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-hover shadow-sm" id="projectsTable">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>PCD301</td>
                        <td>Online Shopping Website with Secure Payment Gateway</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>PCD302</td>
                        <td>Hospital Management System with Electronic Medical Records</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="text-center px-4 wow fadeInUp" data-wow-delay="0.3s">
        <p class="m-5 fs-6">Whether you're a student, researcher, or professional aiming to strengthen your .NET development skills, Projectscorner is your trusted partner for IEEE standard projects. <strong>Build, innovate, and succeed with us!</strong></p>
    </div>
